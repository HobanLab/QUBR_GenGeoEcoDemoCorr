...
#kruskall wallis test
kruskal.test(vol_water_0.5 ~ Locality, data = fixed_field_data_processed_trees_soils)
...
#kruskall wallis test
kruskal.test(vol_water_100.200 ~ Locality, data = fixed_field_data_processed_trees_soils)
