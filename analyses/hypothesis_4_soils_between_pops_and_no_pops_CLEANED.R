...
# 4) Making a function for calculating the real and randomized mean soil metrics, comparing the real
...
# 6) Using a heat map to summarize the results (the mean soil metrics and their significances)
...
random_pop_soils <- function(){
  ...
  return(list(known_soil_means = known_soil_means, #soil mean list
         ...
         random_points_BCS_crop = random_points_BCS_crop, #randomly generated points plot
