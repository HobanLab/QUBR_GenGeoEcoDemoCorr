...
#   geom_sf(data = SD_fixed_field_data_processed_source)
...
LM_elevation_raster_15_data_pts <- extract(CEM_15_utm_LM, LM_fixed_field_data_processed_source) #extracting the elevation for each point value
LM_fixed_field_data_processed_source_terrain <- cbind(LM_fixed_field_data_processed_source, LM_aspect_raster_15_data_pts) #bind the aspect data for each point to the LM point dataframe
...
LC_aspect_raster_15_data_pts <- extract(LC_aspect_raster_15, LC_fixed_field_data_processed_source) #extracting aspect for each point value
LC_slope_raster_15_data_pts <- extract(LC_slope_raster_15, LC_fixed_field_data_processed_source) #extracting slope for each point value
LC_elevation_raster_15_data_pts <- extract(CEM_15_utm_LC, LC_fixed_field_data_processed_source) #extracting the elevation for each point value
LC_fixed_field_data_processed_source_terrain <- cbind(LC_fixed_field_data_processed_source, LC_aspect_raster_15_data_pts) #bind the aspect data for each point to the LC point dataframe
...
SD_aspect_raster_15_data_pts <- extract(SD_aspect_raster_15, SD_fixed_field_data_processed_source) #extracting aspect for each point value
SD_slope_raster_15_data_pts <- extract(SD_slope_raster_15, SD_fixed_field_data_processed_source) #extracting slope for each point value
SD_elevation_raster_15_data_pts <- extract(CEM_15_utm_SD, SD_fixed_field_data_processed_source) #extracting the elevation for each point value
SD_fixed_field_data_processed_source_terrain <- cbind(SD_fixed_field_data_processed_source, SD_aspect_raster_15_data_pts) #bind the aspect data for each point to the SD point dataframe
...
#SD
SD_fixed_field_data_processed_source_terrain_dist <- cbind(SD_fixed_field_data_processed_source_terrain, SD_fixed_field_data_processed_source_distance)
...
ggplot(LM_fixed_field_data_processed_source) + # Short Canopy Axis
  geom_histogram(aes(x = Canopy_short))+
  xlab("Short Canopy Axis")+
  ylab("Frequency")

ggplot(LM_fixed_field_data_processed_source) + # Long Canopy Axis
  geom_histogram(aes(x = Canopy_long))+
  xlab("Long Canopy Axis")+
  ylab("Frequency")

ggplot(LM_fixed_field_data_processed_source) + # Crown Spread
  geom_histogram(aes(x = Crown_spread))+
  xlab("Canopy Spread")+
  ylab("Frequency")

ggplot(LM_fixed_field_data_processed_source) + # Canopy Area
  geom_histogram(aes(x = Canopy_area))+
  xlab("Canopy Area")+
  ylab("Frequency")

ggplot(LM_fixed_field_data_processed_source) + # DBH
  geom_histogram(aes(x = DBH_ag))+
  xlab("Aggregated DBH")+
  ylab("Frequency")
...
ggplot(LC_fixed_field_data_processed_source) + # Short Canopy Axis
  geom_histogram(aes(x = Canopy_short))+
  xlab("Short Canopy Axis")+
  ylab("Frequency")

ggplot(LC_fixed_field_data_processed_source) + # Long Canopy Axis
  geom_histogram(aes(x = Canopy_long))+
  xlab("Long Canopy Axis")+
  ylab("Frequency")

ggplot(LC_fixed_field_data_processed_source) + # Crown Spread
  geom_histogram(aes(x = Crown_spread))+
  xlab("Canopy Spread")+
  ylab("Frequency")

ggplot(LC_fixed_field_data_processed_source) + # Canopy Area
  geom_histogram(aes(x = Canopy_area))+
  xlab("Canopy Area")+
  ylab("Frequency")

ggplot(LC_fixed_field_data_processed_source) + # DBH
  geom_histogram(aes(x = DBH_ag))+
  xlab("Aggregated DBH")+
  ylab("Frequency")

#SD
ggplot(SD_fixed_field_data_processed_source) + # Short Canopy Axis
  geom_histogram(aes(x = Canopy_short))+
  xlab("Short Canopy Axis")+
  ylab("Frequency")

ggplot(SD_fixed_field_data_processed_source) + # Long Canopy Axis
  geom_histogram(aes(x = Canopy_long))+
  xlab("Long Canopy Axis")+
  ylab("Frequency")

ggplot(SD_fixed_field_data_processed_source) + #  Crown Spread
  geom_histogram(aes(x = Crown_spread))+
  xlab("Canopy Spread")+
  ylab("Frequency")

ggplot(SD_fixed_field_data_processed_source) + # Canopy Area
  geom_histogram(aes(x = Canopy_area))+
  xlab("Canopy Area")+
  ylab("Frequency")

ggplot(SD_fixed_field_data_processed_source) + # DBH
  geom_histogram(aes(x = DBH_ag))+
  xlab("Aggregated DBH")+
  ylab("Frequency")
...
# LM
ggplot(LM_fixed_field_data_processed_source) + 
  geom_histogram(aes(x = Elevation..m.FIXED))+
  xlab("Elevation (m)")+
  ylab("Frequency")

#LC
ggplot(LC_fixed_field_data_processed_source) + 
  geom_histogram(aes(x = Elevation..m.))+
  xlab("Elevation (m)")+
  ylab("Frequency")

#SD
ggplot(SD_fixed_field_data_processed_source) + 
  geom_histogram(aes(x = Elevation..m.))+
  xlab("Elevation (m)")+
  ylab("Frequency")
...
#LM
ggplot(LM_fixed_field_data_processed_source_terrain) + 
  geom_histogram(aes(x = LM_slope_raster_15_data_pts))+
  xlab("Slope (degrees)")+
  ylab("Frequency")

#LC
ggplot(LC_fixed_field_data_processed_source_terrain) + 
  geom_histogram(aes(x = LC_slope_raster_15_data_pts))+
  xlab("Slope (degrees)")+
  ylab("Frequency")

#SD
ggplot(SD_fixed_field_data_processed_source_terrain) + 
...
#LM
ggplot(LM_fixed_field_data_processed_source_terrain) + #generate the base plot
  geom_bar(aes(x = LM_aspect_raster_15_data_pts_4_categorical))+
  xlab("Direction")+
  ylab("Frequency")

#LC
ggplot(LC_fixed_field_data_processed_source_terrain) + #generate the base plot
  geom_bar(aes(x = LC_aspect_raster_15_data_pts_4_categorical))+
  xlab("Direction")+
  ylab("Frequency")

#SD
ggplot(SD_fixed_field_data_processed_source_terrain) + #generate the base plot
...
ggplot()+ #plot of distance raster with points overlaid
  ...
  geom_sf(data = SD_fixed_field_data_processed_source_sf, col = "white")+
  scale_fill_viridis_c()
...
LM_points_intersects_river <- st_intersects(LM_fixed_field_data_processed_source, river_LM_trans, sparse = F) #creating a list of true or falses for whether points intersect the river shapefiles
LM_fixed_field_data_processed_source_intersects_river <- cbind(LM_fixed_field_data_processed_source, LM_points_intersects_river) #binding the list of true or falses with the point data
#printing the river polygon and the tree points, colored by whether are or aren't within or overlapping with the river
ggplot()+
  geom_sf(data=river_LM_trans)+
  geom_sf(data=LM_fixed_field_data_processed_source)+
  geom_sf(data=LM_fixed_field_data_processed_source_intersects_river, aes(color = LM_points_intersects_river))

#LC 

#Assigning points within and overlapping with the river to be "true"
LC_points_intersects_river <- st_intersects(LC_fixed_field_data_processed_source, river_LC_trans, sparse = F) #creating a list of true or falses for whether points intersect the rivershapefiles
LC_fixed_field_data_processed_source_intersects_river <- cbind(LC_fixed_field_data_processed_source, LC_points_intersects_river) #binding the list of true or falses with the point data
#printing the river polygon and the tree points, colored by whether are or aren't within or overlapping with the river
ggplot()+
  geom_sf(data=river_LC_trans)+
  geom_sf(data=LC_fixed_field_data_processed_source)+
  geom_sf(data=LC_fixed_field_data_processed_source_intersects_river, aes(color = LC_points_intersects_river))

#SD

#Assigning points within and overlapping with the river to be "true"
SD_points_intersects_river <- st_intersects(SD_fixed_field_data_processed_source, river_SD_trans, sparse = F) #creating a list of true or falses for whether points intersect the rivershapefiles
SD_fixed_field_data_processed_source_intersects_river <- cbind(SD_fixed_field_data_processed_source, SD_points_intersects_river) #binding the list of true or falses with the point data
#printing the river polygon and the tree points, colored by whether are or aren't within or overlapping with the river
ggplot()+
  geom_sf(data=river_SD_trans)+
  geom_sf(data=SD_fixed_field_data_processed_source)+
  geom_sf(data=SD_fixed_field_data_processed_source_intersects_river, aes(color = SD_points_intersects_river))

## Extracting distance to river for each tree using the distance to river raster

#LM
LM_distance_data_pts <- st_extract(dist_near_river_buffer_LM, LM_fixed_field_data_processed_source) #extracting distance to river for each tree
LM_fixed_field_data_processed_source_distance  <- cbind(LM_fixed_field_data_processed_source, LM_distance_data_pts) #binding the distance to river data for each point to the LM point dataframe


#LC
LC_distance_data_pts <- st_extract(dist_near_river_buffer_LC, LC_fixed_field_data_processed_source) #extracting distance to river for each tree
LC_fixed_field_data_processed_source_distance  <- cbind(LC_fixed_field_data_processed_source, LC_distance_data_pts) #binding the distance to river data for each tree to the LC point dataframe


#SD
SD_distance_data_pts <- st_extract(dist_near_river_buffer_SD, SD_fixed_field_data_processed_source) #extracting distance to river for each tree
SD_fixed_field_data_processed_source_distance  <- cbind(SD_fixed_field_data_processed_source, SD_distance_data_pts) #binding the distance to river data for each point to the SD point dataframe

## Assigning all points within/overlapping river to distances of 0

#LM
LM_fixed_field_data_processed_source_distance <- LM_fixed_field_data_processed_source_distance %>% 
...
#LC
LC_fixed_field_data_processed_source_distance <- LC_fixed_field_data_processed_source_distance %>%
...
#SD
SD_fixed_field_data_processed_source_distance <- SD_fixed_field_data_processed_source_distance %>%
...
LM_fixed_field_data_processed_source <- LM_fixed_field_data_processed_source %>%
  mutate(X_sequential = 1:nrow(LM_fixed_field_data_processed_source))
...
LC_fixed_field_data_processed_source <- LC_fixed_field_data_processed_source %>%
  mutate(X_sequential = 1:nrow(LC_fixed_field_data_processed_source))
...
SD_fixed_field_data_processed_source <- SD_fixed_field_data_processed_source %>%
  mutate(X_sequential = 1:nrow(SD_fixed_field_data_processed_source))

## Extracting the soil data to the tree points 

#LM
LM_soil_text_raster_250_data_pts <- raster::extract(soil_stack_LM_soil_text, LM_fixed_field_data_processed_source) #extracting soil textures for each point value
LM_soil_other_raster_250_data_pts <- raster::extract(soil_stack_LM_other, LM_fixed_field_data_processed_source) #extracting the other soil variables for each point value
LM_soil_extra_raster_250_data_pts <- raster::extract(soil_stack_LM_extra, LM_fixed_field_data_processed_source) #extracting the extra soil variables for each point value
LM_fixed_field_data_processed_source_soils <- cbind(LM_fixed_field_data_processed_source, LM_soil_text_raster_250_data_pts) #bind the soil textures data for each point to the LM point dataframe
LM_fixed_field_data_processed_source_soils <- cbind(LM_fixed_field_data_processed_source_soils, LM_soil_other_raster_250_data_pts) #bind the other soil variable data for each point to the LM point dataframe
LM_fixed_field_data_processed_source_soils <- cbind(LM_fixed_field_data_processed_source_soils, LM_soil_extra_raster_250_data_pts) #bind the extra soil variable data for each point to the LM point dataframe

#LC
LC_soil_text_raster_250_data_pts <- raster::extract(soil_stack_LC_soil_text, LC_fixed_field_data_processed_source) #extracting soil textures for each point value
LC_soil_other_raster_250_data_pts <- raster::extract(soil_stack_LC_other, LC_fixed_field_data_processed_source) #extracting the other soil variables for each point value
LC_soil_extra_raster_250_data_pts <- raster::extract(soil_stack_LC_extra, LC_fixed_field_data_processed_source) #extracting the extra soil variables for each point value
LC_fixed_field_data_processed_source_soils <- cbind(LC_fixed_field_data_processed_source, LC_soil_text_raster_250_data_pts) #bind the soil textures data for each point to the LC point dataframe
LC_fixed_field_data_processed_source_soils <- cbind(LC_fixed_field_data_processed_source_soils, LC_soil_other_raster_250_data_pts) #bind the other soil variable data for each point to the LC point dataframe
LC_fixed_field_data_processed_source_soils <- cbind(LC_fixed_field_data_processed_source_soils, LC_soil_extra_raster_250_data_pts) #bind the extra soil variable data for each point to the LC point dataframe

#SD
SD_soil_text_raster_250_data_pts <- raster::extract(soil_stack_SD_soil_text, SD_fixed_field_data_processed_source) #extracting soil textures for each point value
SD_soil_other_raster_250_data_pts <- raster::extract(soil_stack_SD_other, SD_fixed_field_data_processed_source) #extracting the other soil variables for each point value
SD_soil_extra_raster_250_data_pts <- raster::extract(soil_stack_SD_extra, SD_fixed_field_data_processed_source) #extracting the extra soil variables for each point value
SD_fixed_field_data_processed_source_soils <- cbind(SD_fixed_field_data_processed_source, SD_soil_text_raster_250_data_pts) #bind the soil textures data for each point to the LC point dataframe
SD_fixed_field_data_processed_source_soils <- cbind(SD_fixed_field_data_processed_source_soils, SD_soil_other_raster_250_data_pts) #bind the other soil variable data for each point to the LC point dataframe
SD_fixed_field_data_processed_source_soils <- cbind(SD_fixed_field_data_processed_source_soils, SD_soil_extra_raster_250_data_pts) #bind the extra soil variable data for each point to the LC point dataframe
...
LM_fixed_field_data_processed_source_soils <- LM_fixed_field_data_processed_source_soils %>%
...
LC_fixed_field_data_processed_source_soils <- LC_fixed_field_data_processed_source_soils %>%
...
SD_fixed_field_data_processed_source_soils <- SD_fixed_field_data_processed_source_soils %>%
  mutate(sandy_avail_water_0.5 = vol_water_0.5 - vol_water_.1500kPa_0.5) %>% # Sand Available Water 0-5 cm
  mutate(sandy_avail_water_100.200 = vol_water_100.200 - vol_water_.1500_100.200) %>% # Sand Available Water 100-200 cm
  mutate(clay_loam_avail_water_0.5 = vol_water_.10_0.5 - vol_water_.1500kPa_0.5) %>% # Clay/Loam Available Water 0-5 cm
  mutate(clay_loam_avail_water_100.200 = vol_water_.10_100.200 - vol_water_.1500_100.200) # Clay/Loam Available Water 100-200 cm
...
fixed_field_data_processed_source_trees_soils <- rbind(LM_fixed_field_data_processed_source_trees_soils, LC_fixed_field_data_processed_source_trees_soils) #combining the LM and LC soil and randomly chosen tree data
fixed_field_data_processed_source_trees_soils <- rbind(fixed_field_data_processed_source_trees_soils, SD_fixed_field_data_processed_source_trees_soils) #combining the SD tree point data to the LM and LC soil and randomly chosen tree point data
